...
/**
 * Tabla interna para almacenar la relaci�n entre los leds del sistema y
 * su posici�n dentro del d�gito correpondiente
 */
...
//! Valor interno del d�gito conectado al los leds rojos
static uint8_t digitRed;

//! Valor interno del d�gito conectado al los leds verdes
static uint8_t digitGreen;

//! Valor interno del d�gito conectado al los leds azules
